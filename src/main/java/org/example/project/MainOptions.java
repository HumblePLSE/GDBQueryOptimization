...
import org.example.project.Randomly.StringGenerationStrategy;
...
public class MainOptions {
    ...
    @Parameter(names = "--target-db", description = "Target database: neo4j or memgraph (default: neo4j)")
    private String targetDb = "neo4j";

    // 存储从 config.json 中提取的所有版本号
