...
public class QuantifiedPathPatternClause {
    ...
    public QuantifiedPathPatternClause(NodePatternClause startNodePattern,NodePatternClause endNodePattern, int direction, String relationshipVariable, List<String> typeIdentifiers, LengthQuantifier lengthQuantifier) {
    ...
    public static QuantifiedPathPatternClause generateRandomVarLengthRelationship(GraphManager graphManager) {
        ...
        return new QuantifiedPathPatternClause(startNodePattern,endNodePattern,direction, pathVariable, typeIdentifiers, lengthQuantifier);
    }
}
