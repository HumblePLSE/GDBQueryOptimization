...
public class RelationshipPatternClause extends Clause {
    ...
    //不新增加变量
    public static RelationshipPatternClause generateRandomRelationshipPatternDontNewRe(AbstractRelationship relationship, String direction, GraphManager graphManager) {
        ...
        if (randomly.getBoolean()) {
            ...
            List<String> existingrelationshipVariables = new ArrayList<>(relationshipVariableManager.getAllRelationshipVariables());
            if (!existingrelationshipVariables.isEmpty()){
                relationshipVariable = existingrelationshipVariables.get(randomly.getInteger(0,existingrelationshipVariables.size()));
            }
        }
