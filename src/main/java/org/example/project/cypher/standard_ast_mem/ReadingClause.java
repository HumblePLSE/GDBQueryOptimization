...
public class ReadingClause extends Clause {
    ...
    public static ReadingClause generateReadingClause(GraphManager graphManager,boolean optional) {
        // 使用生成器函数生成 Match_Clause 和 GraphPatternClause
        MatchClause matchClause = MatchClause.generateRandomMatchClause(optional);
