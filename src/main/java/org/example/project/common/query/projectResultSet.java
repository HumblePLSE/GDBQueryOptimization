...
//            }
    ...
    public boolean compare(projectResultSet secondprojectResultSet, boolean withOrder) {
        if (getRowNum() == 0 || secondprojectResultSet.getRowNum() == 0) {
            if (getRowNum() == secondprojectResultSet.getRowNum()) {
                return true;
            } else {
                return false;
            }
        ...
        List<String> secondSortList = new ArrayList<>(secondprojectResultSet.resultToStringList());
    ...
    public boolean compareWithOrder(projectResultSet secondprojectResultSet) {
        return compare(secondprojectResultSet, true);
    }
    public boolean compareWithOutOrder(projectResultSet secondprojectResultSet) {
        return compare(secondprojectResultSet, false);
    }

    public projectResultSet(org.neo4j.driver.Result rs) {
    ...
    public projectResultSet(ResultSet rs) throws SQLException {
        resultRowNum = 0;
        result = new ArrayList<Map<String, Object>>();
    ...
    public projectResultSet(com.redislabs.redisgraph.ResultSet rs) throws SQLException {
    ...
    public projectResultSet(redis.clients.jedis.graph.ResultSet rs) {
    ...
    public projectResultSet(List<Map<String, Object>> gremlinResults) {
    ...
    public projectResultSet(String rs) {
        result = new ArrayList<>();
        if (rs.equals("null")) {
            resultRowNum = 0;
        } else {
