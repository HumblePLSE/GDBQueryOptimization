...
//        Neo4jDriverManager.closeDriver(driver);
    ...
    private static class Response{
        public projectResultSet projectResultSet;
...
//            System.out.println(new String(responseBytes));
            ...
            response.projectResultSet.resolveFloat();
            return new ArrayList<>(Arrays.asLpackage org.example.project.neo4j;
...
//            System.out.println(new String(responseBytes));
            ...
            response.projectResultSet.resolveFloat();
            return new ArrayList<>(Arrays.asList(response.projectResultSet));
        }
    }
}
